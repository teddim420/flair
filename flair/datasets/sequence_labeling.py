...
class HAUSA_NER(ColumnCorpus):
    def __init__(
        ...
        # download data if necessary
        hausa_ner_path = "https://github.com/masakhane-io/masakhane-ner/tree/main/data/hau"
        cached_path(f"{hausa_ner_path}dev.txt", Path("datasets") / dataset_name)
        cached_path(f"{hausa_ner_path}test.txt", Path("datasets") / dataset_name)
        cached_path(f"{hausa_ner_path}train.txt", Path("datasets") / dataset_name)
